            ...
            <form id="main_form" name="form" action="update.php" method="post">
                ...
                <div class="page_content" id="page-1" name="PersonalInformation">
                    <fieldset class="name">
                        ...
                        <input type="text" name="lastname" onclick="document.getElementById('span1.1').style.display='none'" onkeypress="document.getElementById('span1.1').style.display='none'" placeholder="Last" style="width: 32.5%" value="<?php echo $row['lname']?>";>
