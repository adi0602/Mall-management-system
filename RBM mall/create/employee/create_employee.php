            ...
            <form name="form" action="send.php" method="post">
                ...
                <div class="page_content" id="page-1" name="PersonalInformation">
                    <fieldset class="name">
                        ...
                        <input type="text" name="lastname" onclick="document.getElementById('span1').style.display='none'" onkeypress="document.getElementById('span1').style.display='none'" placeholder="Last" style="width: 33%">
                ...
                <div class="page_content" id="page-2" name="JobInformation">
                    ...
                    <fieldset class=supervisor>
                        ...
                        <input type="text" style="width: 50%" name="supervisor">
                    </fieldset>
                ...
                <div class="page_content" id="page-3" name="Emergency">
                    <fieldset class=Name>
                        ...
                        <input type="text" name="ecdlastname" placeholder="Last" style="width: 33%">
