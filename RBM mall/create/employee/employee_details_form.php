            ...
            <form id="main_form" name="form" action="" method="post">
                ...
                <div class="page_content" id="page-2" name="JobInformation">
                    ...
                    <fieldset style="margin-top: 10px;" class="password" hidden="true">
                        ...
                        <input type="text" style="width: 50%" name="password" id="password">
                    </fieldset>
                ...
                <div class="page_content" id="page-3" name="Emergency">
                    <fieldset class=Name>
                        ...
                        <input type="text" name="ecdlastname" onclick="document.getElementById('span9.1').style.display='none'" onkeypress="document.getElementById('span9.1').style.display='none'" placeholder="Last" style="width: 32.5%">
