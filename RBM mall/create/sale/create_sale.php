    ...
    <body>
        <div class="sales_form">
            ...
            <form id="details" name="form" action="" method="post">
                ...
                <fieldset class="cust">
                    ...
                    <!--                    <input type="text" id="phone" name="phone" required style="width: 49.7%">-->
                ...
                <fieldset class="order_details">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input class="quantity" id="qty1" name="qty1" type="number" placeholder="quantity"/></td>
        ...
        <script>
            ...
            function add(){
                ...
                var add='<tr><td><button class="delete" onclick="$(this).closest('+tr+').remove();"><strong>x</strong></button></td><td><select class="prod" id="'+id+'" name="'+id+'"><option value=""></option></select></td></td><td><input type=text id="price'+i+'" name="price'+i+'" readonly style="cursor: not-allowed"></td><td><input class="quantity" id="qty'+i+'" name="qty'+i+'" type="number" placeholder="quantity"/><td><input type="number" id="disc'+i+'" name="disc'+i+'" value=0 placeholder="discount"></td><td><input type="text" id="total'+i+'" name="total'+i+'" style="cursor: not-allowed" readonly></td></tr>';
                i++;
                $('table').append(add);
            ...
            $(document).on('click','select', function () {
                ...
                document.getElementById('qty'+xid.substring(4,xid.length)).click();
            });
            ...
            $(document).on('click keyup','td', function(e){
                ...
                //                d=document.getElementById('rowid');
                //                d.value=$(this).get(0).parentElement.rowIndex;
                //                var rowid=$(this).get(0).parentElement.rowIndex;
                ...
                if(colid==3 || colid==4)
                {
                    ...
                    {
//                        alert(d.value);
                        total.value=((quantity.value)*(price.value)*(100-discount.value)/100);
                    }
                    if(e.keyCode==13)
                        e.preventDefault();
                }
