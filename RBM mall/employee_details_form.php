            ...
            <form name="form" action="send.php" method="post">
                ...
                <div class="page_content" id="page-1" name="PersonalInformation">
                    <fieldset class="name">
                        ...
                        <input type="text" name="lastname" onclick="document.getElementById('span1.1').style.display='none'" onkeypress="document.getElementById('span1.1').style.display='none'" placeholder="Last" style="width: 33%">
                ...
                <div class="page_content" id="page-2" name="JobInformation">
                    <fieldset class=title>
                        ...
                        <select name=title onclick="document.getElementById('span5').style.display='none'" onkeypress="document.getElementById('span5').style.display='none'" style="width: 50%;">
                            <option></option>
                            <option>Sales Clerk</option>
                            <?php if(preg_match('/^A.*/',$_SESSION["eid"]))echo "<option>Store Manager</option>";
                            ?>
                        </select>
                    ...
                    <fieldset class=department>
                        ...
                        <option>Food</option>";
                                ...
                                echo"<option value='-'></option><option>Clothing</option>";
                            else
                                echo"<option value='-'></option><option>Food</option>";
                            ?>
                            <!--
<option value="-"></option>
<option>Clothing</option>
...
-->
                    ...
                    if(preg_match('/^A.*/',$_SESSION["eid"]))
                    {
                        ...
                        <input type='select' style='width: 50%;' name='supervisor'>";
                        $conn = mysqli_connect('localhost', 'root', "", 'mall');
                        if($conn->connect_error) {
                        die("Connection failed: " . $conn->connect_error);
                        }
                        else{
//                            $super=mysqli_query("select  from ");
                        }
                        echo "</fieldset>";
                    }
                    ?>
                    ...
                    <fieldset class=salary>
                        ...
                        <input type="text" name="salary" onclick="document.getElementById('span8').style.display='none'" onkeypress="document.getElementById('span8').style.display='none'" type="date" style="width: 50%">
                ...
                <div class="page_content" id="page-3" name="Emergency">
                    <fieldset class=Name>
                        <legend><strong>Name</strong><a style="color: red"><strong>*</strong></a></legend>
                        <input type="text" name="ecdfirstname" onclick="document.getElementById('span9').style.display='none'" onkeypress="document.getElementById('span9').style.display='none'" placeholder="First" required style="width: 33%;">
                        <input type="text" name="ecdmiddlename" placeholder="Middle" style="width: 33%">
                        <input type="text" name="ecdlastname" onclick="document.getElementById('span9.1').style.display='none'" onkeypress="document.getElementById('span9.1').style.display='none'" placeholder="Last" style="width: 33%">
                    ...
                    <fieldset class=address>
                        ...
                        <input type="text" name="ecdaddress" onclick="document.getElementById('span10').style.display='none'" onkeypress="document.getElementById('span10').style.display='none'" placeholder="Address" required style="width: 100%; margin-bottom: 5px">
                        <input type="text" name="ecdcity" onclick="document.getElementById('span10').style.display='none'" onkeypress="document.getElementById('span10').style.display='none'" placeholder="City" required style="width: 49.7%; margin-bottom: 5px">
                        <input type="text" name="ecdstate" onclick="document.getElementById('span10').style.display='none'" onkeypress="document.getElementById('span10').style.display='none'" placeholder="State" required style="width: 49.7%">
                    ...
                    <fieldset class=relationship>
                        ...
                        <input type="text" name="relationship" onclick="document.getElementById('span12').style.display='none'" onkeypress="document.getElementById('span12').style.display='none'" required style="width: 49.7%">
                    ...
                    <input type="submit" class="btn" value="submit" onclick="if(validateEmergency())alert('loggedin')">
                </div>
